...
### Env variables 🌐
The operating system contained in the `icub-head`/`pc104` is tipically installed by IIT (you can download the [images](https://icub-tech-iit.github.io/documentation/icub_operating_systems/download)). For more information, check the relevant [documentation[https://icub-tech-iit.github.io/documentation/icub_operating_systems/pc104/icub-live].
